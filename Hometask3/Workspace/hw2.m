...
% Задание: 
% Данный файл содержит 3 ссылки на функции, которые вы должны прописать: AWGnoise, MERest, Nerr 
...
% =========================================================================
 ...
 %> Проверьте работоспособнотсь функции в условии передескретизации
    ...
    rxSig = rxfilter(NoiseSig.'); % передискретизация (1 выборка на символ) и фильтрация
...
% =========================================================================
%> Задание 4. Написать функцию, вычесляющую колличество ошибок в битовой
